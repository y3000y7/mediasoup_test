...
import viewFilmStripIcon from "../../images/icon-default-view.svg";
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <img
          src={viewFilmStripIcon}
          alt="viewFilmStripIcon"
          className={classes.viewFilmStripIcon}
          onClick={() => {
            this.props.setDisplayMode("filmstrip");
          }}
        />
      </div>
    );
