...
const ListPeer = props => {
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.peerInfo}>{peer.displayName}</div>
      {peer.raisedHand && (
        <IconButton
      ...
      >
        {currentMenu === "moreActions" && (
          <Paper>
            ...
            <MenuItem
              disabled={
                peer.peerVideoInProgress || !webcamConsumer || !spotlight
              }
              onClick={() => {
                // handleMenuClose();
            ...
            <MenuItem
              disabled={
                peer.peerScreenInProgress || !screenConsumer || !spotlight
              }
              onClick={() => {
                // handleMenuClose();
            ...
            >
              {screenVisible ? <ScreenIcon /> : <ScreenOffIcon />}
              <p className={classes.moreAction}>
                {screenVisible ? (
                  <FormattedMessage
            ...
            >
              {!isSelected ? <AddToQueueIcon /> : <RemoveFromQueueIcon />}
              <p className={classes.moreAction}>
                {!isSelected ? (
                  <FormattedMessage
            ...
            {isModerator && (
              <React.Fragment>
                ...
                <MenuItem
                  disabled={
                    !screenConsumer || peer.stopPeerScreenSharingInProgress
                  }
                  onClick={() => {
                    // handleMenuClose();
